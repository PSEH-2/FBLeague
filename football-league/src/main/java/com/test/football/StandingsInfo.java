...
public class StandingsInfo {
    ...
    {
        return "ClassPojo [away_league_W = "+away_league_W+", overall_league_D = "+overall_league_D+", home_league_PTS = "+home_league_PTS+", overall_league_payed = "+overall_league_payed+", overall_league_L = "+overall_league_L+", home_league_GF = "+home_league_GF+", home_league_position = "+home_league_position+", away_league_L = "+away_league_L+", away_league_payed = "+away_league_payed+", home_league_GA = "+home_league_GA+", country_name = "+country_name+", overall_league_GA = "+overall_league_GA+", overall_league_position = "+overall_league_position+", home_league_W = "+home_league_W+", overall_league_GF = "+overall_league_GF+", away_league_D = "+away_league_D+", overall_league_W = "+overall_league_W+", home_league_payed = "+home_league_payed+", home_league_L = "+home_league_L+", league_name = "+league_name+", home_league_D = "+home_league_D+", team_name = "+team_name+", overall_league_PTS = "+overall_league_PTS+", away_league_GF = "+away_league_GF+", away_league_GA = "+away_league_GA+", away_league_position = "+away_league_position+", away_league_PTS = "+away_league_PTS+", league_id = "+league_id+"]";
    }
}
